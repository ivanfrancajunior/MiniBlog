  ...
  return (
    <div className="flex  flex-col container items-center justify-start gap-4  min-h-screen h-auto ">
      <div className="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-[#bfff00]">Descrição do Projeto</h2>
          <p className="mt-2 ">
        ...
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-[#bfff00]">Tecnologias Utilizadas</h2>
          <p className="mt-2 ">
        ...
        <h1 className="text-3xl font-extrabold mb-4">Sobre o Objetivo</h1>
          <h2 className="text-xl font-semibold text-[#bfff00]">Objetivo</h2>
        ...
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-[#bfff00]">Estrutura do Projeto</h2>
          <p className="mt-2 ">
